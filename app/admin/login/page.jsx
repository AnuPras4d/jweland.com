...
export default function AdminLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (res.ok && data.success) {
      // ✅ No need to set localStorage. Cookie is already set server-side.
      router.push('/admin');
    } else {
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 bg-white/50 backdrop-blur-sm"
                  required
                />
              </div>
            </div>
